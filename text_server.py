...
def add_text():
    try:
        ...
        try:
            # 감정가 폰트 크기를 53px로 수정 적용
            try:
                font_price = ImageFont.truetype("/System/Library/Fonts/SF-Pro-Display-Bold.otf", 53)
            except:
                try:
                    font_price = ImageFont.truetype("/System/Library/Fonts/Avenir Next.ttc", 53)
                except:
                    font_price = ImageFont.truetype("/System/Library/Fonts/Helvetica.ttc", 53)
